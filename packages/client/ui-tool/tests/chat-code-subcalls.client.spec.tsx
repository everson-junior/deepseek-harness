...
import { en as conversationEn, NS as CONVERSATION_NS, ptBR as conversationPtBR, zh as conversationZh } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
async function bench(snapshot: ChatSnapshot) {
  ...
  locale.register(CONVERSATION_NS, { zh: conversationZh, en: conversationEn, 'pt-BR': conversationPtBR })
