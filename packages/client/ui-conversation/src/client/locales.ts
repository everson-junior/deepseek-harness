...
/** Brazilian Portuguese dictionary, derived from English for complete key coverage. */
export const ptBR = {
  ...en,
  ...
  'placeholder.parentOffline': 'A sessão pai está offline; não é possível enviar, mas você ainda pode interromper a execução',
  'placeholder.hero': 'Descreva o que deseja criar, / comandos, @ arquivos ou sessões',
  ...
  'input.send.steer': 'Intervir na mensagem',
  'input.accessMode': 'Modo de acesso, atual: {name}',
  'settings.enter.title': 'Comportamento de envio durante execução',
  ...
  'access.confirm.description': 'Com acesso total, o agente solicitará menos confirmações e poderá executar mais operações diretamente, inclusive ações sensíveis, alterações de arquivos e comandos externos. Use somente em tarefas nas quais você confia.',
