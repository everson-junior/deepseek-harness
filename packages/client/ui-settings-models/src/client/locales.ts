...
export const en = {
  ...
  copilotSigningIn: 'Signing in…',
  copilotOpenUrl: 'Open the verification page',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  copilotSigningIn: '登录中…',
  copilotOpenUrl: '打开验证页面',
...
/** Brazilian Portuguese dictionary for the Models settings section. */
export const ptBR = {
  ...en,
  nav: 'Modelos',
  title: 'Modelos',
  ...
  deleteDescription: 'Excluir {provider} remove sua configuração. As credenciais usadas são gerenciadas em outro local e serão preservadas.',
  ...
  copilotSignIn: 'Entrar com GitHub',
  copilotSigningIn: 'Entrando…',
  copilotOpenUrl: 'Abrir página de verificação',
