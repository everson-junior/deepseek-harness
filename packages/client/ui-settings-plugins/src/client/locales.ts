...
/** Brazilian Portuguese copy for the plugin settings section. */
export const ptBR: Record<PluginsSettingsLocaleKey, string> = {
  ...
  readOnly: 'Esta implantação armazena configurações somente para leitura.',
  ...
  bashMaxOutputBytesHint: 'A saída excedente vai para um arquivo temporário em vez de ser perdida.',
  ...
  webSearchApiKeyUnset: 'Nenhuma chave está configurada; a pesquisa ficará indisponível até que uma seja informada.',
  webSearchBaseUrl: 'Endpoint',
  ...
  subagentModelSelectionChoose: 'Quando ativado, os agentes podem escolher provedor, modelo e esforço de raciocínio para cada subagente entre os modelos autorizados abaixo. Aplica-se somente a novas sessões.',
  ...
  subagentModelSelectionPartial: 'Alguns provedores de modelos não puderam ser carregados; escolhas salvas ainda podem ser removidas.',
  ...
  subagentModelSelectionConflict: 'As configurações foram alteradas em outro lugar. Descarte o rascunho e tente novamente.',
  subagentModelSelectionOff: 'Os subagentes usam os padrões configurados ou herdam o modelo do agente pai. As escolhas salvas são mantidas.',
}
